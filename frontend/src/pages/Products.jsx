    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-5 sm:flex-row'>
          ...
          <div className='w-full sm:w-[65vh]'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-100 px-6 py-6 text-sm text-gray-600'>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At ullam eos consequatur repudiandae asperiores rerum omnis incidunt voluptates, inventore tempora nihil sunt vel, distinctio fugiat veritatis aut alias, provident aliquam exercitationem ipsum quisquam excepturi! Aspernatur perspiciatis dolores veritatis voluptate recusandae.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi quam dignissimos nam nisi, maxime consectetur, rerum, in eaque possimus quo iure at reiciendis quae impedit.</p>
        </div>
      </div>
